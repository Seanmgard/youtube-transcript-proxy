...
export function Pricing() {
  ...
  return (
    <div id="pricing" className="bg-white dark:bg-gray-900 py-12 sm:py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-10 flex justify-center">
          <div className="grid grid-cols-2 gap-x-1 rounded-full p-1 text-center text-xs font-semibold leading-5 bg-gray-100 dark:bg-gray-800">
            ...
            >
              Annually <span className="text-indigo-600 dark:text-indigo-400">(Save 15%)</span>
            </button>
          </div>
        </div>
            ...
            {visibleTiers.map((tier, tierIdx) => (
              <motion.div
                ...
                className={`relative flex flex-col rounded-2xl ${
                  tier.mostPopular
                    ? 'z-10 bg-white dark:bg-gray-800 shadow-xl ring-1 ring-gray-900/10 dark:ring-white/10 lg:scale-105'
                    : 'bg-gray-50 dark:bg-gray-900 lg:mt-8'
                } p-8 w-full`}
              >
                {tier.mostPopular ? (
                  ...
                  <Link
                    ...
                    className={`mt-6 block w-full rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 ${
                      tier.mostPopular
                        ...
                        : 'bg-white dark:bg-gray-800 text-indigo-600 dark:text-indigo-400 ring-1 ring-inset ring-indigo-200 dark:ring-indigo-800 hover:ring-indigo-300 dark:hover:ring-indigo-700'
                    }`}
                  >
                    {tier.cta}
                  </Link>
                ...
                <div className="mt-2 flex flex-1 flex-col justify-between">
                  <div>
                    ...
                    <ul className="mt-6 space-y-3 text-sm leading-6 text-gray-600 dark:text-gray-300">
